                                   ...
                                   intptr_t data, struct Buffer *err)
{
  ...
  mutt_extract_token(cmd, s,
                     (data & (MUTT_SEND_HOOK | MUTT_SEND2_HOOK |
                              MUTT_REPLY_HOOK)) ?
                         MUTT_TOKEN_SPACE :
                         MUTT_TOKEN_NO_FLAGS);
  ...
  if (C_DefaultHook && (~data & MUTT_GLOBAL_HOOK) &&
  ...
  TAILQ_FOREACH(hook, &Hooks, entries)
  {
    ...
    {
      if (data & (MUTT_SEND_HOOK | MUTT_SEND2_HOOK | MUTT_MESSAGE_HOOK |
                  MUTT_REPLY_HOOK))
      {
                                   ...
                                   intptr_t data, struct Buffer *err)
{
  ...
  mutt_extract_token(cmd, s,
                     (data & (MUTT_FOLDER_HOOK | MUTT_ACCOUNT_HOOK )) ?
                         MUTT_TOKEN_SPACE :
                         MUTT_TOKEN_NO_FLAGS);
